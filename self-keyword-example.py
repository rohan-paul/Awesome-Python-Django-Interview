...
__init__ does act like a constructor. You'll need to pass "self" to any class functions as the first argument
if you want them to behave as non-static methods. "self" are instance variables for your class.
...
does not use the ‘@’ syntax to refer to instance attributes. In Python, we have methods that make
